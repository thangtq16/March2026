classdef hPre6GAPLowPHY < nr5g.internal.nrGNBPHY
        ...
        function pdschTx(obj, pdschPkts)
            ...
            if strcmp(obj.Split, "Centralized")
                ...
                for i=1:length(pdschPkts)
                    ...
                    signalAmp = db2mag(obj.TransmitPower-30)*sqrt(obj.WaveformInfo.Nfft^2/(12*obj.CarrierConfig.NSizeGrid));
                    % Apply the Tx power
    ...
    methods(Hidden)
        function data = pdschData(obj, pdschInfo, cpuPDU)
            ...
            signalAmp = db2mag(obj.TransmitPower-30)*sqrt(obj.WaveformInfo.Nfft^2/(size(pdschGrid, 1)));
            % Apply the Tx power
        ...
        function packet = pdschPacket(obj, pdschInfoList, pdschDataList, startTime, ueTagInfo)
            ...
            scaledPower = db2mag(obj.TransmitPower-30) * sqrt((obj.WaveformInfo.Nfft^2) / (12*obj.CarrierConfig.NSizeGrid));
