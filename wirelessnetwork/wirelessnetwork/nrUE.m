    ...
    methods(Access = public)
        function obj = nrUE(varargin)
            ...
            for idx=1:numel(obj)
                ...
                % Set up MAC
                ue.MACEntity = nr5g.internal.nrUEMAC( ...
                ...
                if strcmp(ue.PHYAbstractionMethod, "none")
                    ue.PhyEntity = nr5g.internal.nrUEFullPHY(phyInfo, @(varargin) ueWeakRef.Handle.processEvents(varargin{:})); % Full PHY
                    ue.PHYAbstraction = 0;
                else
                    ue.PhyEntity = nr5g.internal.nrUEAbstractPHY(phyInfo, @(varargin) ueWeakRef.Handle.processEvents(varargin{:})); % Abstract PHY
                    ue.PHYAbstraction = 1;
                end
