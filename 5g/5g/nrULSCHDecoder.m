...
%   info            - UL-SCH decoder status information
...
%#codegen
    ...
    properties
        ...
        LimitedBufferRateRecovery (1, 1) logical = false;
    ...
    methods
        ...
        function set.LimitedBufferRateRecovery(obj,val)

            obj.LimitedBufferRateRecovery = val;
            obj.pEnableLBRR = val;

        end

        function resetSoftBuffer(obj,varargin)
        %resetSoftBuffer Reset soft buffer for specified HARQ process
        %
        ...
        %   'BlockID'   - Transport block ID, 0 (default) or 1
            ...
            resetSoftBuffer@nr5g.internal.TransportChannelDecoder(obj,false,varargin{:});
    ...
    methods(Static = true, Access=protected)
        function groups = getPropertyGroupsImpl
            ...
            propList = {'MultipleHARQProcesses', ...
                        ...
                        'AutoFlushSoftBuffer', ...
                        'TargetCodeRate', ...
                        'TransportBlockLength', ...
                        'LimitedBufferRateRecovery', ...
                        'LimitedBufferSize', ...
                        'LDPCDecodingAlgorithm', ...
                        'ScalingFactor', ...
                        'Offset', ...
