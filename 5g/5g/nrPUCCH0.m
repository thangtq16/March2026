function sym = nrPUCCH0(ack,sr,symAllocation,cp,nslot,nid,groupHopping,initialCS,freqHopping,varargin)
...
%#codegen
    ...
    nIRB = [];
    sym = nr5g.internal.pucch.hPUCCH0(ack,sr,symAllocation,cp,nslot,nid,groupHopping,initialCS,freqHopping,Mrb,nIRB,optargs{:});
