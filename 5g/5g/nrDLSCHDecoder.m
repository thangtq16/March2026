...
%   info            - DL-SCH decoder status information
...
%#codegen
    ...
    methods
        ...
        function obj = nrDLSCHDecoder(varargin)
            ...
            obj@nr5g.internal.TransportChannelDecoder(varargin{:});

            obj.pEnableLBRR = true;
        ...
        %   'BlockID'   - Transport block ID, 0 (default) or 1
            ...
            resetSoftBuffer@nr5g.internal.TransportChannelDecoder(obj,true,varargin{:});
