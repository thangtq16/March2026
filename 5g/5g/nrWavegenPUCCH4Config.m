classdef nrWavegenPUCCH4Config < nr5g.internal.wavegen.EnablePower & ...
                                 nr5g.internal.pucch.Format4ConfigBase & ...
                                 nr5g.internal.wavegen.PUCCH34Common
    %nrWavegenPUCCH4Config PUCCH format 4 configuration object for 5G waveform generation
    %   PUCCH = nrWavegenPUCCH4Config creates a physical uplink control
    %   channel (PUCCH) configuration object. This object contains all the
    %   parameters of PUCCH format 4.
    %
    %   The default nrWavegenPUCCH4Config object configures a PUCCH format
    %   4 allocated in the first resource block and spanning over 14 OFDM
    ...
    %   bits.
    %
    %   PUCCH = nrWavegenPUCCH4Config(Name,Value) creates a physical uplink
    ...
    %
    %   Example: 
    %   % Display the default properties of PUCCH format 4, in case of
    %   % no frequency hopping.
    %
    %   pucch = nrWavegenPUCCH4Config;
    ...
    properties (Hidden)
        ...
        CustomPropList = {'Enable', 'Label', 'Power', 'BandwidthPartID', ...
            'Modulation', 'SymbolAllocation', 'SlotAllocation', 'Period', 'PRBSet', ...
            'FrequencyHopping', 'SecondHopStartPRB', ...
            'GroupHopping', 'HoppingID', 'SpreadingFactor', 'OCCI', ...
            'AntennaMapping', 'PrecodingMatrix', 'NID', 'RNTI', ...
            'Coding', 'TargetCodeRate', 'NumUCIBits', 'DataSourceUCI', ...
    ...
    methods
        % Constructor
        function obj = nrWavegenPUCCH4Config(varargin)
            obj = obj@nr5g.internal.pucch.Format4ConfigBase(...
                  'Label', 'PUCCH format 4', ...
                  'NumUCIBits', 10, ...
                  varargin{:});
        end
        ...
        function validateConfig(obj)
            ...
            validateConfig@nr5g.internal.wavegen.PUCCH34Common(obj,'4');
            % Check Power
    ...
    methods (Access=protected)
        ...
        function inactive = isInactiveProperty(obj, prop)
            ...
            inactive = inactive || isInactiveProperty@nr5g.internal.pucch.Format4ConfigBase(obj, prop);
        end
    end
end
