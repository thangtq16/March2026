classdef Format0ConfigBase < nr5g.internal.pucch.CommonConfig ...
        & nr5g.internal.FrequencyHoppingConfig & nr5g.internal.pucch.Formats01Common
%Format0ConfigBase Class offering properties common between nrPUCCH0Config
%and nrWavegenPUCCH0Config
%
...
%#codegen
    ...
    methods
        % Constructor
        function obj = Format0ConfigBase(varargin)
        ...
        function validateConfig(obj)
            ...
            if ~isempty(obj.SymbolAllocation)
                ...
                coder.internal.errorIf(...
                    ...
                    'nr5g:nrPUCCH:InvalidNumSymbolsShortPUCCH',numSymbols,'0');
            end
        end
    end
